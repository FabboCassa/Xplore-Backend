...
public class OverpassApiService
{
    ...
    private static List<OverpassPoi> ParseOverpassResponse(string json)
    {
        ...
        foreach (var element in elements.EnumerateArray())
        {
            ...
            var name = PoiClassifier.GetTag(tags, "name") ?? "Unknown";
            ...
            var description = PoiClassifier.GetTag(tags, "description")
                           ?? PoiClassifier.GetTag(tags, "note")
                           ?? PoiClassifier.GetTag(tags, "description:en");

            var imageUrl = PoiClassifier.GetTag(tags, "image")
            ...
            result.Add(new OverpassPoi(
                ...
                Latitude: poiLat,
                Longitude: poiLon,
                Type: PoiClassifier.ClassifyType(tags),
